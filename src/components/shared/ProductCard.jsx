    ...
    <div className="product-card  border rounded-2xl shadow-2xl overflow-hidden transition-shadow duration-300">
      ...
      <div className="p-4">
        <h2
          ...
          className="text-lh font-semibold mb-1 cursor-pointer"
        >
          {truncateText({ text: productName, charLimit: 50 })}
        </h2>
        <div className="min-h-12 max-h-12">
          <p className="text-gray-600 text-sm">
            {truncateText({ text: description, charLimit: 80 })}{" "}
          </p>
        </div>
        ...
        <div className="flex flex-col justify-between my-2 ">
          ...
          <button
            ...
            onClick={() => {}}
            className={`bg-blue-500 text-white p-1 lg:mx-1 mt-1 rounded-lg items-center transition-colors duration-300 w-36 flex justify-center  
                            ${
                              isAvailable
